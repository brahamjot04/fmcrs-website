...
/* themes/gin/templates/admin/update-project-status.html.twig */
class __TwigTemplate_fcf00bd4ef8d9632d85f8c0ba6148e6b extends Template
{
...
($context["project"] ?? null), "status", [], "any", false, false, true, 36) == Twig\Extension\CoreExtension::constant("Drupal\\update\\UpdateManagerInterface::CURRENT"))) ? ("project-update__status--current gin-status gin-status--success") : (""))];
  ...
  <span class=\"gin-status-icon\">
    ";
        // line 41
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["status"] ?? null), "icon", [], "any", false, false, true, 41), 41, $this->source), "html", null, true);
        yield "
  </span>";
        // line 43
        if (CoreExtension::getAttribute($this->env, $this->source, ($context["status"] ?? null), "label", [], "any", false, false, true, 43)) {
            // line 44
            yield "<span>";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["status"] ?? null), "label", [], "any", false, false, true, 44), 44, $this->source), "html", null, true);
            yield "</span>";
        } else {
            // line 46
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["status"] ?? null), "reason", [], "any", false, false, true, 46), 46, $this->source), "html", null, true);
        }
        // line 48
        yield "</div>
...
";
    ...
    {
        return "themes/gin/templates/admin/update-project-status.html.twig";
    }
    ...
    {
        return new Source("", "themes/gin/templates/admin/update-project-status.html.twig", "C:\\laragon\\www\\fmcrs-website\\web\\themes\\gin\\templates\\admin\\update-project-status.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("set" => 31, "if" => 43, "for" => 63, "trans" => 90);
